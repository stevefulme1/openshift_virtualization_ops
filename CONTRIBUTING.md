# Contributing to openshift_virtualization_ops

Thank you for your interest in contributing to **openshift_virtualization_ops**!
...
```bash
git clone https://github.com/stevefulme1/openshift_virtualization_ops.git
cd openshift_virtualization_ops
```
